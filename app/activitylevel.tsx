...
export default function ActivityLevel() {
    ...
    const [selected, setSelected] = useState<ActivityKey>("sedentary");
    ...
    const options = useMemo(
        () => [
            ...
            },
            {
                ...
                multiplier: 1.725,
                icon: "fitness-outline" as IoniconName, // FIXED HERE
            },
            {
    ...
    return (
        <View className="flex-1 bg-[#eef2f1] px-6 pt-12">
            ...
            <View className="relative mb-6">
                <Pressable
                    onPress={() => router.back()}
                    className="absolute left-0 top-3 w-12 h-12 rounded-full bg-white items-center justify-center"
                >
                ...
                {options.map((o) => {
                    ...
                    return (
                        <Pressable
                            ...
                            className={`rounded-3xl p-5 flex-row items-center justify-between ${isActive
                        ...
                        >
                            <View className="flex-row items-center">
                                <View
                                    className={`w-16 h-16 rounded-2xl items-center justify-center ${isActive ? "bg-[#76C893]" : "bg-gray-100"
                                        }`}
                                >
                                    <Ionicons
                                        name={o.icon}
                            ...
                            {/* Radio Circle */}
                            <View
                                className={`w-7 h-7 rounded-full border-2 items-center justify-center ${isActive
                                        ? "border-[#76C893]"
                                        : "border-gray-300"
                                    }`}
                            >
